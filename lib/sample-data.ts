...
export const sampleNews = [
  { id: '1', title: 'Noon Raises $500M in Series D Funding Round', source: 'TechCrunch', date: '2026-01-05', company: 'Noon', summary: 'E-commerce giant Noon secures massive funding to expand across MENA region with new fulfillment centers.', significance_score: 8.5, relevance_score: 9.2, trustScore: 9.0, matchStatus: 'match' as const },
  { id: '2', title: 'Careem Launches Super App in Saudi Arabia', source: 'Bloomberg', date: '2026-01-04', company: 'Careem', summary: 'Uber-owned Careem expands its super app services to include food delivery and payments in KSA.', significance_score: 7.8, relevance_score: 8.7, trustScore: 9.0, matchStatus: 'not_match' as const },
  { id: '3', title: 'Kitopi Opens 50 New Cloud Kitchens in UAE', source: 'Arabian Business', date: '2026-01-03', company: 'Kitopi', summary: 'Food-tech unicorn accelerates expansion with new cloud kitchen locations across Dubai and Abu Dhabi.', significance_score: 6.2, relevance_score: 7.1, trustScore: 5.0, matchStatus: 'match' as const },
  { id: '4', title: 'Anghami Goes Public on NASDAQ', source: 'Reuters', date: '2026-01-02', company: 'Anghami', summary: 'Arab world\'s leading music streaming platform becomes first Arab tech company to list on NASDAQ.', significance_score: 9.1, relevance_score: 9.8, trustScore: 9.0, matchStatus: 'match' as const },
  { id: '5', title: 'Swvl Expands Mass Transit to Latin America', source: 'The Verge', date: '2026-01-01', company: 'Swvl', summary: 'Egyptian mobility startup enters Latin American market with bus booking services in Mexico and Colombia.', significance_score: 7.3, relevance_score: 8.0, trustScore: 9.0, matchStatus: 'not_match' as const },
  { id: '6', title: 'Fawry Partners with Major Banks for Digital Payments', source: 'Fintech News', date: '2025-12-30', company: 'Fawry', summary: 'Egypt\'s leading fintech company announces strategic partnerships with five major banks.', significance_score: 6.8, relevance_score: 7.5, trustScore: 5.0, matchStatus: 'match' as const },
];
